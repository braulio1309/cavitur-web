...
const form = reactive({ full_name: '', email: '', phone: '', profile_type: 'Agencia de Viajes Establecida', message: '' })
const formTabs = [
...
async function handleSubmit() {
  ...
  try { const result = await submitContact(form); success.value = result.message; form.full_name = ''; form.email = ''; form.phone = ''; form.message = '' }
      ...
      <div class="row gy-5 align-items-center">
        <div class="col-lg-5">
          ...
          <div class="d-flex flex-column gap-3">
            ...
            <div class="d-flex align-items-center gap-3 p-3 bg-cream rounded-3 border"><div class="icon-circle bg-cavitur-green text-white"><i class="bi bi-whatsapp"></i></div><div><h6 class="fw-bold text-dark-green mb-0">Atención Directa</h6><small class="text-muted">+58 (412) 000-0000 / contacto@cavitur.com</small></div></div>
          </div>
        </div>
        <div class="col-lg-7">
